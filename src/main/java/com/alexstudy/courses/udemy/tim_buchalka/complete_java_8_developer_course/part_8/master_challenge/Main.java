...
public class Main {
    public static void main(String[] args) {
        ...
        Burger bb1 = new BaseBurger("potato");
        System.out.printf("Price is %d\n", bb1.getPrice());
        Burger bb2 = new BaseBurger("potato", "souse", "meat", "cheese");
        System.out.printf("Price is %d\n", bb2.getPrice());
//        Burger bb3 = new BaseBurger("potato", "souse", "meat", "cheese", "cheese", "cheese", "cheese");

//        Burger hb1 = new HealthyBurger("potato");
        Burger hb1 = new HealthyBurger("potato", "cheese");
        System.out.printf("Price is %d\n", hb1.getPrice());
        Burger hb2 = new HealthyBurger("potato", "cheese", "meat");
        System.out.printf("Price is %d\n", hb2.getPrice());
        Burger hb3 = new HealthyBurger("potato", "cheese", "meat", "lettuce");
        System.out.printf("Price is %d\n", hb3.getPrice());

        Burger db1 = new DeluxBurger();
        System.out.printf("Price is %d\n", db1.getPrice());
