package com.alexstudy.courses.udemy.tim_buchalka.complete_java_8_developer_course.part_13.adventure_map_challenge;
...
public class Main {
    ...
    public static void main(String[] args) {
        // Change the program to allow players to types full words, or phrases, then move to the
        // correct location based upon their input.
        // The player should be able to types commands such as "Go West", "run South", or just "East"
        ...
        while(true) {
            ...
            // run East, go West, West
                ...
                } else System.out.println("You cant types first word '" + words[0] + "', only 'run' or 'go'");
            }
